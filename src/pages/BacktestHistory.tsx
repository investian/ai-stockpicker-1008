...
import { TrendingUp, Calendar, Clock, Target, Activity, ArrowUp, ArrowDown } from 'lucide-react';
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="text-center">
              <h1 className="text-4xl font-bold mb-4">Backtest History</h1>
              <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                Historical performance of your portfolio recommendations and trades
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {paginatedData.map((record) => (
            <div
              key={record.id}
              className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
            >
